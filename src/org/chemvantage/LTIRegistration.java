...
public class LTIRegistration extends HttpServlet {
	...
	String instructions = "<h3>Implementation in Canvas (other LMS platforms may be similar)</h3>"
			...
			+ "<li>The instructor page for that assignment should then be shown, which allows you to set the deadline, customize "
			+ "the selection of questions, and select other options for the assignment."
			+ "<li>Navigate in Canvas to Settings, Student View to take the assignment and ensure that the score is posted correctly in the Canvas grade book."
			+ "</ol>"
