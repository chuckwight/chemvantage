...
public class LTIRegistration extends HttpServlet {
	...
	String welcomeMessage = "<h2>LTI Support Page</h2>"
			...
			+ "<td>ChemVantage supports the IMS Global Learning Solutions LTI standard, versions 1.0, 1.1 and 2.0. The IMS conformance registration "
