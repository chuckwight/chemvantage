...
public class About extends HttpServlet {
	...
	public static String accounts = "<h3>Instructors</h3>"
		...
		+ "Instructors can customize quiz and homework assignments for their classes using the link near the top "
		+ "of every quiz or homework assignment page."
	...
	public static String copyright = "<a NAME=copyright></a>"
		...
		+ "DMCA Office, ChemVantage LLC, 1784 Shadow Ridge Circle, Ogden, UT 84403 USA, admin@chemvantage.org<p>"
