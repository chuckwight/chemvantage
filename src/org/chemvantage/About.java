...
public class About extends HttpServlet {
	...
	public static String terms = "<a NAME=terms></a>"
		...
		+ "Your continued use of the Site following the posting of changes to this policy will be deemed your acceptance of those changes.</LI>"
		+ "<LI>CONTACTING US<br>"
		...
		+ "<LI>These terms and conditions were last updated on April 12, 2020</LI>"
		+ "</UL>";
