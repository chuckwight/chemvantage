...
public class About extends HttpServlet {
	...
	public static String premium = "<a NAME=accounts></a>"
		...
		+ "www.chemvantage.org</a>. Chemistry instructors can also make "
	...
	public static String terms = "<a NAME=terms></a>"
		...
		+ "No names, no addresses, no phone numbers, no email addresses. Because ChemVantage is a free service, " 
		+ "we do not process, collect or store any user financial information whatsoever."
		...
		+ "<li><b>User IDs</b> - ChemVantage tracks a single user ID web session variable to identify our users as they navigate "
		+ "through the site to ensure their privacy and security. For LTI users, this ID is provided by the learning "
		+ "management system (LMS) and consists of a unique name that identifies the LMS followed by an opaque set of random "
		+ "characters and digits that the LMS uses to identify its users. LTI is a secure messaging and communications standard "
		+ "developed by the <a href=https://www.imsglobal.org>IMS Global Learning Consortium</a>. LTI connects students and "
		+ "instructors with providers of educational services, and ChemVantage is a "
		+ "<a href=https://site.imsglobal.org/certifications/chemvantage/36981/chemvantage>certified LTI provider</a>.<br>"
		...
		+ "available to the user, the instructor (as identified by the LMS) and to the LMS administrator. User scores may "
		...
		+ "as site navigation and user experience. We also use timestamps to automatically delete user accounts and data after "
		...
		+ "<LI>These terms and conditions were last updated on July 2, 2019"
		+ "</UL>";
