...
public class About extends HttpServlet {
	...
	public static String terms = "<a NAME=terms></a>"
		...
		+ "directly via email (e.g., to establish an account), Chemvantage does not store any user PII. No names, no passwords, " 
		+ "no addresses, no phone numbers. Because ChemVantage is a free service, " 
