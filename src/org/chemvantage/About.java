...
public class About extends HttpServlet {
	...
	public static String premium = "<a NAME=accounts></a>"
		...
		+ "All ChemVantage LTI accounts expire automatically after one year of inactivity.<p>"
		+ "ChemVantage can afford to be free because "
	...
	public static String certification = "<a NAME=certification></a>"
		...
		+ "LMS grade book. You can get a free set of ChemVantage LTI credentials at <a href=/lti/registration target=_blank>our LTI registration page</a>.";
