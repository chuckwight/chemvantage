...
public class Question implements Serializable, Cloneable {
	...
	public String print(String showWork,String studentAnswer) {
		...
		case 5: // Numeric Answer
			...
			case 1: buf.append("<span style='color:#EE0000;font-size: small;'>Enter the answer with the appropriate number of significant figures. For scientific notation use a format like " + String.format("%."+significantFigures+"G",4.2873648E-15) + "</span><br/>"); break;
			case 2: buf.append("<span style='color:#EE0000;font-size: small;'>Enter the correct answer to within " + requiredPrecision + "% precision. For scientific notation use a format like 4.29E-15</span><br/>"); break;
			case 3: buf.append("<span style='color:#EE0000;font-size: small;'>Enter the answer with the appropriate number of significant figures. For scientific notation use a format like " + String.format("%."+significantFigures+"G",4.2873648E-15) + "</span><br/>"); break;
			default:
			}			
