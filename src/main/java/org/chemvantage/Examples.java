...
public class Examples extends HttpServlet {
	...
	throws ServletException, IOException {
		...
		out.println(examplesPage(getSig()));
	}
	...
	static String examplesPage(String sig) {
		return "<!DOCTYPE html>"
				+ "<html lang='en'>"
				+ "<head>"
				+ "    <meta charset='UTF-8'>"
				...
				+ "                        </p>"
				+ "                        <a href='/SmartText?sig=" + sig + "' target='_blank' aria-label='Opens new tab' class='btn btn-two'>"
				...
				+ "                        </p>"
				+ "                        <a href='/VideoQuiz?&sig=" + sig + "' target='_blank' aria-label='Opens new tab' class='btn btn-two'>"
				+ "                            Try a Sample Video"
				+ "                        </a>"
				+ "                    </div>"
				+ "                </div>"
