...
public class ProposedQuestion extends Question {
	...
	ProposedQuestion (long conceptId,long videoId,String text,String type,int nChoices,List<String> choices,
		...
		super(conceptId,text,type,nChoices,choices,requiredPrecision,significantFigures,correctAnswer,tag,pointValue,parameterString,hint,solution,authorId,contributorId,editorId,notes);
	}
}