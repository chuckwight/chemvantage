...
<%@ page
	import="java.util.*,com.googlecode.objectify.*,org.chemvantage.*"%>
...
<meta name='Keywords'
	content='chemistry,learning,online,quiz,homework,video,textbook,open,education'>
...
<body bgcolor=#ffffff text=#000000 link=#0000cc vlink=#551a8b
	...
	%>
	<mark>
		As the course instructor you may <a
			href='/Quiz?UserRequest=AssignQuizQuestions&sig=<%=user.getTokenSignature()%>'>customize
			this assignment</a>.
		<%
	...
	<p>
		...
		Quiz Rules
	<OL>
		<LI>Each quiz must be completed within <%=timeAllowed / 60%>
			minutes of the time when it is first downloaded.
		</LI>
		<LI>You may repeat quizzes as many times as you wish, to improve
			your score.</LI>
		<LI>ChemVantage always reports your best score on this assignment
			to your class LMS.</LI>
	</OL>
	<%
		}
	%>
	...
	<div id=ctrl0 style='font-size: 50%; color: red;'>
		<a href=javascript:toggleTimers()>hide timers</a>
		<p>
	</div>
	...
	<FORM NAME=Quiz id=quizForm METHOD=POST ACTION=Quiz
		...
		<div id=ctrl1 style='font-size: 50%; color: red;'>
			<a href=javascript:toggleTimers()>hide timers</a>
			<p>
		</div>
